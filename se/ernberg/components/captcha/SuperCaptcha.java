...
public class SuperCaptcha extends JPanel implements DocumentListener,
	...
	public SuperCaptcha(CaptchaPainter captchaPainter) {
	 ...
	 */
	public SuperCaptcha(CaptchaTextGenerator captchaTextGenerator) {
	...
	private static CaptchaPainter getDefaultPainter() {
		return new CaptchaColorPainter();
	}
	...
	private static CaptchaTextGenerator getDefaultTextGenerator() {
		return new CaptchaSimpleTextGenerator();
	}
	 ...
	 * @author Gustav Ernberg <gustav.ernberg@gmail.com>
	 */
	private class CaptchaImage extends JPanel implements HierarchyBoundsListener {
		/**
		 * Generated by Eclipse
		 */
		...
		private void updateSize() {
			int width = getCaptchaPainter().calculateWidth(
